...
public:
    ...
    void setupUi(QDialog *ComparisonDialog)
    {
        ...
        ComparisonDialog->resize(420, 458);
...
"to help advanced users setting the general parameters", nullptr));
        preciseResultsTabWidget->setTabText(preciseResultsTabWidget->indexOf(approxTab), QApplication::translate("ComparisonDialog", "Approximate distances", nullptr));
