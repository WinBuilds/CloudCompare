...
public:
    ...
    void setupUi(QDialog *AsciiOpenDialog)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 984, 430));
        ...
        toolButtonShortcutDotcomma->setText(QString::fromUtf8(";"));
    ...
    void retranslateUi(QDialog *AsciiOpenDialog)
    {
        ...
        label->setText(QApplication::translate("AsciiOpenDialog", "Here are the first lines of this file. Choose an attribute for each column (one cloud at a time):", nullptr));
